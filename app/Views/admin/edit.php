        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card-box">
                    ...
                    <h4 class="header-title mt-0 mb-3">Edit User <?= $id['username']; ?></h4>
                    <form action="/dashboard/admin/update/<?= $id['id']; ?>" method="POST" data-parsley-validate
                        novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" parsley-trigger="change" required placeholder="Enter name"
                                ...
                                id="nama" value="<?= (old('nama')) ? old('nama') : $id['nama']  ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" parsley-trigger="change" required
                                ...
                                id="username" value="<?= $id['username']; ?>" readonly>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="telp" parsley-trigger="change" required
                                placeholder="Enter no telp" class="form-control" id="telp" value="<?= $id['telp']; ?>">
                        </div>
